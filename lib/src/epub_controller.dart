...
class EpubController {
  ...
  setTheme({required int fontSize, required String background, required String colorText}) {
    checkEpubLoaded();
    webViewController?.evaluateJavascript(source: 'setBackgroundColor("$fontSize","$background", "$colorText")');
  }
